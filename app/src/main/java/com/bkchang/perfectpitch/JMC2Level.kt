...
class JMC2Level : AppCompatActivity() {
    val question = QUESTION_BANK_JMC2.random()
    val answers = QUESTION_BANK_JMC2.filter { it != question }.map {it}
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_j_m_c2_level)
        val player = MediaPlayer.create(this, question.chord)
        player.start()

        val button6 = findViewById<Button>(R.id.button6)
        button6.setOnClickListener {player.start()}
